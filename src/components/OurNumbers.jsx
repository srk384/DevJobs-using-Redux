const OurNumbers = () => {
  return (
    <div className="py-10 pb-20">
      ...
      <div className="flex gap-2 md:gap-4 mx-auto max-w-7xl items-center md:justify-center overflow-auto">
        <div className="p-4 bg-gray-200 dark:bg-slate-900 dark:text-white rounded-lg text-center">
            ...
            <div className="text-lg text-gray-700 dark:text-gray-300 whitespace-nowrap">Active Users</div>
        </div>
        <div className="p-4 bg-gray-200 dark:bg-slate-900 dark:text-white rounded-lg text-center">
        ...
        <div className="p-4 bg-gray-200 dark:bg-slate-900 dark:text-white rounded-lg text-center">
            ...
            <div className="text-lg text-gray-700 dark:text-gray-300 whitespace-nowrap">Jobs Offered</div>
        </div>
        <div className="p-4 bg-gray-200 dark:bg-slate-900 dark:text-white rounded-lg text-center">
