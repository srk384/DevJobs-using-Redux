    ...
    <div className="py-10 max-w-[1215px] mx-auto relative">
      ...
      <div className="overflow-auto md:overflow-hidden py-5 ">
        <motion.div
          ...
          //   animate={{ x: "-23%" }}
        >
          {jobsData.slice(0, 10).map((job, index) => (
            <div
              className="w-52 md:w-72 border border-gray-300 dark:border-gray-700 rounded-xl shrink-0 group hover:shadow-xl active:shadow-xl transition bg-white dark:bg-slate-900"
              key={index}
            >
